...
void AverageWindSpeed(const WindlogType& log); //Menu option 1
...
void AverageAirTemp(const WindlogType& log); //Menu option 2
...
void TotalSolarRad(const WindlogType& log); //Menu option 3
void OutputData(const WindlogType& log); //Menu option 4
